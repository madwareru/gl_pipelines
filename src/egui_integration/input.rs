...
pub fn egui_key_from_gl_p_key(key: gl_p::window::KeyCode) -> Option<egui::Key> {
    Some(match key {
        ...
        gl_p::window::KeyCode::_0 => egui::Key::Num0,
        gl_p::window::KeyCode::_1 => egui::Key::Num1,
        gl_p::window::KeyCode::_2 => egui::Key::Num2,
        gl_p::window::KeyCode::_3 => egui::Key::Num3,
        gl_p::window::KeyCode::_4 => egui::Key::Num4,
        gl_p::window::KeyCode::_5 => egui::Key::Num5,
        gl_p::window::KeyCode::_6 => egui::Key::Num6,
        gl_p::window::KeyCode::_7 => egui::Key::Num7,
        gl_p::window::KeyCode::_8 => egui::Key::Num8,
        gl_p::window::KeyCode::_9 => egui::Key::Num9,
